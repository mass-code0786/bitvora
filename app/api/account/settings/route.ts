...
const defaults={language:"en",currency:"USD",emailNotifications:true,pushNotifications:true,tradeNotifications:true};
const input=z.object({language:z.enum(["en","hi"]),currency:z.enum(["USD","INR"]),emailNotifications:z.boolean(),pushNotifications:z.boolean(),tradeNotifications:z.boolean()}).strict();
const view=(value:typeof defaults)=>({language:value.language,currency:value.currency,emailNotifications:value.emailNotifications,pushNotifications:value.pushNotifications,tradeNotifications:value.tradeNotifications});
